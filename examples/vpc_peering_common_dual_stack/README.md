...
| <a name="input_policy_routes"></a> [policy\_routes](#input\_policy\_routes) | n/a | `any` | n/a | yes |
| <a name="input_policy_routes_trust_vpc_network_key"></a> [policy\_routes\_trust\_vpc\_network\_key](#input\_policy\_routes\_trust\_vpc\_network\_key) | n/a | `any` | n/a | yes |
